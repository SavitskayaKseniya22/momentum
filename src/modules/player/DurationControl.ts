class DurationControl {
  ...
  addListener() {
    this.audioElement.addEventListener('loadedmetadata', () => {
      ...
      if (durationTotal) {
        durationTotal.textContent = DurationControl.convertDuration(
    ...
    this.audioElement.addEventListener('timeupdate', () => {
      ...
      if (durationProgress) {
        durationProgress.textContent = DurationControl.convertDuration(
  ...
  static convertDuration(value: number) {
